...
function AirPollution() {
  ...
  return (
    <div className="air-pollution col-span-full sm-2:col-span-2 pt-6 px-4 h-[12rem] border rounded-lg flex flex-col gap-8 dark:bg-grey shadow-sm dark:shadow-none">
